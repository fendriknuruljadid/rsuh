...
var WebCodeCamJS = function(element) {
    ...
    var display = Q(element),
        ...
        options = {
            ...
            zoom: 0,
            beep: 'http://utamahusada.esolusindo.com/desain/assets/custom/qr_reader/audio/beep.mp3',
            decoderWorker: 'http://utamahusada.esolusindo.com/desain/assets/custom/qr_reader/js/DecoderWorker.js',
            brightness: 0,
