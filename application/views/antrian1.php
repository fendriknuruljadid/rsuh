...
<div class="page-wrapper" id="utama" style="margin-left:0px;padding-left:50px;">
  <div class="row mt-3">
    ...
    <div class="col-md-3" style="min-height:150px;margin-top:10px;margin-bottom:10px">
      <div class="col-md-12 purple-gradient wrap-antrian" style="height:100%">
        <center><h4>Antrian</h4></center>
        <hr style="background-color:white;"></hr>
        <center><h1 style="font-size:30px;font-family:Consolas;" class="antrian_loket1"><?php echo $antrian['LOKET1']==0?"--":"B".$antrian['LOKET1']?></h1></center>
        <hr style="background-color:white;"></hr>
        <center><h4 style="font-family:Consolas;">Loket 1</h4></center>
      </div>
    </div>
    <div class="col-md-3" style="min-height:150px;margin-top:10px ;margin-bottom:10px ">
      <div class="col-md-12 peach-gradient wrap-antrian" style="height:100%">
        <center><h4>Antrian</h4></center>
        <hr style="background-color:white;"></hr>
        <center><h1 style="font-size:30px;font-family:Consolas;" class="antrian_loket2"><?php echo $antrian['LOKET2']==0?"--":"L".$antrian['LOKET2']?></h1></center>
        <hr style="background-color:white;"></hr>
        <center><h4 style="font-family:Consolas;">Loket 2</h4></center>
      </div>
    </div>
    <div class="col-md-3" style="min-height:150px;margin-top:10px;margin-bottom:10px">
      <div class="col-md-12 blue-gradient wrap-antrian" style="height:100%">
        <center><h4>Antrian</h4></center>
        <hr style="background-color:white;"></hr>
        <center><h1 style="font-size:30px;font-family:Consolas;" class="antrian_kasir"><?php echo $antrian['KASIR']==NULL?"--":$antrian['KASIR']?></h1></center>
        <hr style="background-color:white;"></hr>
        <center><h4 style="font-family:Consolas;">Kasir</h4></center>
      </div>
    </div>
    <div class="col-md-3" style="min-height:150px;margin-top:10px;margin-bottom:10px">
      <div class="col-md-12 blue-gradient wrap-antrian" style="height:100%">
        <center><h4>Antrian</h4></center>
        <hr style="background-color:white;"></hr>
        <center><h1 style="font-size:30px;font-family:Consolas;" class="antrian_apotek"><?php echo $antrian['APOTEK']==NULL?"--":$antrian['APOTEK']?></h1></center>
        <hr style="background-color:white;"></hr>
        <center><h4 style="font-family:Consolas;">Apotek</h4></center>
      </div>
    </div>
  </div>
</div>
...
<script src="<?php echo base_url()?>desain/custom/pusher/antrian1.js"></script>
