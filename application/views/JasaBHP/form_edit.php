      ...
      <div class="col-md-12">
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9">
            <input type="text" name="japel" id="japel" class="form-control" value="<?php echo $japel['nama']?>" placeholder="Pilih Jasa Pelayanan" required>
            <input type="hidden" name="id_japel" id="id_japel" value="<?php echo $japel['kode_jasa']?>">
          </div>
        </div>
        <br>
      ...
      <div class="col-md-12" style="margin-top:20px;">
        ...
        <div class="table-responsive">
          <table id="list_pembelian_obat" class="table editable-table table-bordered table-striped m-b-0">
            ...
            <tbody id="obat">
              <?php foreach ($bhp as $value): ?>
                <tr>
                  <td><input type='hidden' class="bhpku" name='kode_obat[]' value='<?php echo $value->idobat?>'><?php echo $value->idobat."/".$value->nama_obat?></td>
                  <td><input type='number' name='jumlah[]' class='form-control' value='<?php echo $value->jumlah?>'></td>
