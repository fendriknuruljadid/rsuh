...
<?php echo form_open('Laporan/cetak_rekap_ranap_rajal');?>

<div class="row">
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
            <h4><a href="" class="white-text mx-3">Laporan Rekapitulasi Kunjungan Rawat Jalan dan Rawat Inap</a></h4>
      </div>
      <div class="card-body">
        ...
        <div class="row col-md-12">
          <h2>Laporan Rekapitulasi Kunjungan Rawat Jalan dan Rawat Inap</h2>
