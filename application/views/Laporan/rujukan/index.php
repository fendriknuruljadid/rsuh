...
<?php echo form_open('Laporan/rekap_rujukan');?>

<div class="row">
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
            <h4><a href="" class="white-text mx-3">Laporan Rekapitulasi Rujukan Per Poli</a></h4>
      </div>
      <div class="card-body">
        ...
        <div class="row col-md-12">
          <h2>Laporan Rekapitulasi Rujukan Per Poli</h2>
...
<?php echo form_open('Laporan/rekap_rujukan_detail');?>
  ...
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header purple-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
            <h4><a href="" class="white-text mx-3">Laporan Rekapitulasi Rujukan Pasien</a></h4>
      </div>
      <div class="card-body">
        <div class="row p-t-20">
          <div class="col-md-4">
        ...
        <div class="row col-md-12">
          <h2>Laporan Rekapitulasi Rujukan Detail Pada Pasien</h2>
          <div class="table-responsive">
