  ...
  <div class="col-md-12 col-xl-6">
    <div class="form-group animated flipIn">
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" name="noBPJS" disabled id="noBPJS" class="form-control" placeholder="isikan nomor BPJS" value="<?php echo @$pasien['noBPJS']; ?>">
      </div>
    </div>
  </div>
  <div class="col-md-12 col-xl-6">
    <div class="form-group animated flipIn">
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" name="noAsuransiLain" disabled id="noAsuransiLain" class="form-control" placeholder="isikan nomor Asuransi (jika ada)" value="<?php echo @$pasien['noAsuransiLain']; ?>">
      </div>
    </div>
  </div>
