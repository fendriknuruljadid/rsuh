...
<?php echo form_open('JenisObat/delete');?>
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Jenis Obat</a>
            <div>
              <a href="<?php base_url(); ?>JenisObat/input" class="float-right">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
              ...
              <tbody>
                <?php $no=1; foreach ($jenis_obat as $data) {?>
                  <?php $id_check = $data->idjenis_obat;?>
                  <tr>
                      <td>
                      ...
                      <td><a href="<?php base_url()?>JenisObat/edit/<?php echo $data->idjenis_obat;?>">
