    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted m-t-30 m-b-30">Mohon Maaf Anda Tidak Memiliki Akses Ke Halaman Ini!!!</p>
                <a onclick="window.history.back()" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
