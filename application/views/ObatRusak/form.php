...
$(document).ready(function(){
  ...
  $(document).on("click",".tambah_batch",function(){
    ...
    if (list_batch.indexOf(id_pengadaan[id]) > -1) {
      ...
      "<td><input type='number' style='min-width:150px;' id='jml"+kode_obat+"' kode='"+kode_obat+"' class='form-control jml_beli' name='jumlah[]' value='1'></td>" +
