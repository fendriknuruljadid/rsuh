      ...
      <div class="card card-cascade narrower z-depth-1">
        <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
          <div>
              ...
              <a href="" class="white-text mx-3">Tempat Tidur</a>
              <div>
                <a href="<?php base_url(); ?>TempatTidur/input" class="float-right">
                ...
                <?php $no = 1; foreach ($tempat_tidur as $data):
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td><?php echo "Rp.".number_format($data->tarif,2); ?></td>
                      <td><?php echo "Rp.".number_format($data->biaya_makan,2); ?></td>
                      <td><?php echo "Rp.".number_format($data->biaya_makan_penunggu); ?></td>
                      ...
                      <td>
                        <a href="<?php echo base_url().'TempatTidur/edit/'.$id_check; ?>">
