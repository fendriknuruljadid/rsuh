  ...
  <div class="card-body card-block">
    <div class="col-md-12 col">
        <div class="col col-md-12">
          <?php
            for($i=18;$i>=14;$i--){?>
              <span <?php if (@$hasil_periksa['gigi_'.$i]!=null) {
                echo "style='background-color:#01c0c8'";
              }?> tittle="Gigi <?php echo $i;?>" href="#" id="gigi_18" class="gigi" data-toggle="tooltip" data-placement="top" data-original-title="<?php if (@$hasil_periksa['gigi_'.$i]!=null) {
                echo $hasil_periksa['gigi_'.$i];
        ...
        <div class="col col-md-12">
          <div class="table table-responsive">
            ...
            <tbody id="periksa_gigi">
              <?php
                for ($i=11; $i<=85 ; $i++) {
                  if (@$hasil_periksa['gigi_'.$i]!=null) {?>
                    <tr>
                      <td><?php echo "Gigi ".$i;?></td>
                      <td><?php echo @$hasil_periksa['gigi_'.$i]?></td>
                    </tr>
                  <?php
                  }
                }
          ...
          <div class="table table-responsive">
            ...
            <tbody id="periksa_gigi">
                <tr>
                  <td>Occulasi</td>
                  <td><?php if ($hasil_periksa['occulasi']!=null) {
                    echo $hasil_periksa['occulasi'];
                  }else{ echo "-" ; }?></td>
                </tr>
                <tr>
                  <td>Torus Palatinus</td>
                  <td><?php if ($hasil_periksa['torus_palatinus']!=null) {
                    echo $hasil_periksa['torus_palatinus'];
                  }else{ echo "-" ; }?></td>
                </tr>
                <tr>
                  <td>Torus Mandibularis</td>
                  <td><?php if ($hasil_periksa['torus_mandibularis']!=null) {
                    echo $hasil_periksa['torus_mandibularis'];
                  }else{ echo "-" ; }?></td>
                </tr>
                <tr>
                  <td>Palatum</td>
                  <td><?php if ($hasil_periksa['palatum']!=null) {
                    echo $hasil_periksa['palatum'];
                  }else{ echo "-" ; }?></td>
                </tr>
                <tr>
                  <td>Diastema</td>
                  <td><?php if ($hasil_periksa['diastema']!=null) {
                    echo $hasil_periksa['diastema'];
                  }else{ echo "-" ; }?></td>
                </tr>
                <tr>
                  <td>Anomali</td>
                  <td><?php if ($hasil_periksa['gigi_anomali']!=null) {
                    echo $hasil_periksa['gigi_anomali'];
                  }else{ echo "-" ; }?></td>
                </tr>
                <tr>
                  <td>Lain lain</td>
                  <td><?php if ($hasil_periksa['lain_lain']!=null) {
                    echo $hasil_periksa['lain_lain'];
                  }else{ echo "-" ; }?></td>
                </tr>
                <tr>
                  <td>Photo</td>
                  <td><?php if ($hasil_periksa['photo']!=null) {
                    echo $hasil_periksa['photo']." (".$hasil_periksa['jenis_photo'].")";
                  }else{ echo "-" ; }?></td>
                </tr>
                <tr>
                  <td>Rontgen</td>
                  <td><?php if ($hasil_periksa['rontgen']!=null) {
                    echo $hasil_periksa['rontgen']." (".$hasil_periksa['jenis_rontgen'].")";
                  }else{ echo "-" ; }?></td>
                </tr>
            </tbody>
          </table>
