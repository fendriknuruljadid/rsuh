              ...
              <div class="card-body card-block">
                ...
                <div class="card-body card-block">
                  ...
                  <div class="col col-md-3">
                    <label for="tanggal" class=" form-control-label">Tanggal Timbang Terima</label>
                  </div>
                  <div class="col-12 col-md-4">
                    <input type="date" name="tanggal" id="tanggal" class="form-control" placeholder="Tanggal" value="<?php echo date("Y-m-d",strtotime($timbang['waktu_timbangterima'])); ?>"  readonly>
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col col-md-2">
                          ...
                          <div class="row p-t-20 p-b-50">
                            ...
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              ...
                              <div class="input-group" style="margin-bottom:40px">
                                ...
                                <textarea class="form-control" readonly rows="4" name="rekomendas"><?php echo @$timbang['keluhan_umum']; ?></textarea>
                  ...
                  <div class="row p-t-20">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" aria-label="" name="luas_luka" value="<?php echo @$timbang['luas_luka'] ?>" readonly>
                                        ...
                                        <label class=" form-control-label">Jenis Luka :</label>
                                        <!-- </div> -->
                            ...
                            <div class="card-body card-block">
                              <div class="row p-t-20">
                                <div class="input-group mb-3">
                                  ...
                                  <textarea class="form-control" rows="4" readonly name="rekomendas"><?php echo @$timbang['lainnya']; ?></textarea>
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <textarea class="form-control" rows="4" readonly name="rekomendasi"><?php echo @$timbang['rekomendasi']; ?></textarea>
