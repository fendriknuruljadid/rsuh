                          ...
                          <div class="row p-t-20 p-b-50">
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              <div class="form-group animated flipIn">
                                ...
                                <div class="input-group mb-3">
                                  <input type="date" class="form-control" aria-label="" name="tanggal_kunjungan" value="<?php echo $demografi['tanggal_kunjungan'] ?>" readonly>
                                  <div class="input-group-prepend">
                                    <span class="input-group-text">Pukul : </span>
                                  </div>
                                  <input type="text" class="form-control" aria-label="" name="tanggal_jam_kunjungan" value="<?php echo $demografi['tanggal_jam_kunjungan'] ?>" readonly>
                            ...
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              <div class="form-group animated flipIn">
                                ...
                                <div class="input-group mb-3">
                                  <input type="date" class="form-control" aria-label="" name="sumber_data" value="<?php echo $demografi['sumberdata'] ?>" readonly>
                                  <div class="input-group-prepend">
                                    <span class="input-group-text">Sumber data</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              <div class="form-group animated flipIn">
                                ...
                                <div class="input-group mb-3 col-md-12">
                                  <div class="input-group mb-3 col-md-12">
      >
                                    <input type="text" class="form-control" aria-label="" name="dokter" value="<?php echo @$demografi['rujukan']?>" readonly>

                                    <div class="input-group-prepend">
                                      <span class="input-group-text">Dokter : </span>
                                    </div>
                                    <input type="text" class="form-control" aria-label="" name="dokter" value="<?php echo @$demografi['dokter']?>" readonly>
                                    <div class="input-group-prepend">
                                      <span class="input-group-text">RS : </span>
                                    </div>
                                    <input type="text" class="form-control" aria-label="" name="rs" value="<?php echo @$demografi['rs'] ?>" readonly>
                                  </div>
                                  <div class="input-group mb-3 col-md-12">
                                    <div class="input-group-append">
                                      <span class="input-group-text">Lainnya</span>
                                    </div>
                                    <input type="text" class="form-control" aria-label="" name="aak_lainnya" value="<?php echo @$demografi['aak_lainnya'] ?>" readonly>
                            ...
                            <div class="col-xl-12 col-md-12 col-sm-12" >
                              <div class="form-group animated flipIn">
                                ...
                                <input type="text" name="diagnosa_rujukan" value="<?php echo @$demografi['diagnosa_rujukan']; ?>" class="form-control" readonly>
                            ...
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              <div class="form-group animated flipIn">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control" aria-label="" name="td" value="<?php echo @$demografi['td'] ?>">
                                  <div class="input-group-append">
                      ...
                      <div class="card border-info" style="border: 2px solid;">
                        ...
                        <div class="card-body card-block">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-10 row">
                              <div class="col-12 col-lg-2 custom-control custom-radio">
                                <input type="radio" id="seperkawinan1" checked name="seperkawinan" value="Kawin" <?php if (@$demografi['seperkawinan']=='Kawin') {echo "checked";} ?> class="custom-control-input">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-10 row">
                              <div class="col-12 col-lg-2 custom-control custom-radio">
                                <input type="radio" id="tinggal_dengan1" checked name="tinggal_dengan" value="Orang Tua" <?php if (@$demografi['tinggal_dengan']=='Orang Tua') {echo "checked";} ?> class="custom-control-input">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-10 row">
                              ...
                              <div class="col-12 col-lg-2 custom-control custom-radio">
                                <input type="radio" id="cara_pembayaran2" name="cara_pembayaran" value="Asuransi" <?php if (@$jenispasien['jenis_pasien']=="Asuransi") {echo "checked";} ?> class="custom-control-input">
                                <label class="custom-control-label" for="cara_pembayaran2">Asuransi</label>
                              </div>
                              <div class="col-12 col-lg-2 custom-control custom-radio">
                                <input type="radio" id="cara_pembayaran3" name="cara_pembayaran" value="BBJS" <?php if (@$jenispasien['jenis_pasien']=="BPJS") {echo "checked";} ?> class="custom-control-input">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-10 row">
                              <div class="col-12 col-lg-2 custom-control custom-radio">
                                <input type="radio" checked id="agama1" value="Islam" <?php if (@$demografi['agama']=="Islam") {echo "checked";} ?> name="agama" class="custom-control-input">
                            ...
                            <div class="card-body card-block">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-12 row">
                                  <div class="col-12 col-lg-5 custom-control custom-checkbox">
                                    <input type="radio" id="riwayat_penyakit_keluarga1" checked name="riwayat_penyakit_keluarga[]" class="custom-control-input" value="Tidak Ada">
                                  ...
                                  <div class="col-12 col-lg-3 custom-control custom-checkbox">
                                    <input type="radio" id="riwayat_penyakit_keluarga2" name="riwayat_penyakit_keluarga[]" class="custom-control-input" value="Hipertensi">
                                    <label class="custom-control-label" for="riwayat_penyakit_keluarga2">Hipertensi</label>
                                  </div>
                                  <div class="col-12 col-lg-4 custom-control custom-checkbox">
                                    <input type="radio" id="riwayat_penyakit_keluarga3" name="riwayat_penyakit_keluarga[]" class="custom-control-input" value="TB Paru">
                                    <label class="custom-control-label" for="riwayat_penyakit_keluarga3">TB Paru</label>
                                  </div>
                                  <div class="col-12 col-lg-4 custom-control custom-checkbox">
                                    <input type="radio" id="riwayat_penyakit_keluarga4" name="riwayat_penyakit_keluarga[]" class="custom-control-input" value="Diabetes Melitus">
                                  ...
                                  <div class="col-12 col-lg-9 custom-control custom-checkbox">
                                    <input type="radio" id="riwayat_penyakit_keluarga5" name="riwayat_penyakit_keluarga[]" class="custom-control-input" valu="lain">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-12 row">
                                  ...
                                  <div class="col-12 col-lg-3 custom-control custom-radio">
                                    <input type="radio" id="golongan_darah5" checked name="golongan_darah" class="custom-control-input">
                              ...
                              <div class="row form-group col-12">
                                <div class="col-lg-3">
                                  <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" aria-label="" name="pn_bb" id="bb" onkeyup="hitung_imt()">
                                    <div class="input-group-append">
                                ...
                                <div class="col-lg-3">
                                  <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" aria-label="" name="pn_tb" id="tb" onkeyup="hitung_imt()">
                                    <div class="input-group-append">
