                    ...
                    <div class="col-lg-6">
                      <div class="card border-info" style="border: 2px solid;">
                        ...
                        <div class="card-body card-block">
                          <div class="row form-group">
                            <div class="col col-md-2">
                              <label class=" form-control-label">TD :</label>
                            </div>
                            <div class="col-sm-12 col-lg-10 row p-b-10">
                              <div class="col-12 col-lg-9 input-group">
                                <input type="text" class="form-control" aria-label="" name="td" value="<?php echo @$asesmen['td'] ?>">
                                <div class="input-group-append">
                                  <span class="input-group-text">x/mnt</span>
                                </div>
                              </div>
                        ...
                        <div class="card-body card-block">
                          <div class="row form-group">
                            ...
                            <div class="col-sm-12 col-lg-10 row">
                              <div class="col-12 col-lg-12 input-group">
                                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                                  <input type="radio" id="pupil1" name="pupil" value="Isokor" <?php if (@$asesmen['pupil']=='Isokor') {echo "checked";} ?> class="custom-control-input">
                                  <label class="custom-control-label" for="pupil1">Isokor</label>
                                </div>
                                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                                  <input type="radio" id="pupil2" name="pupil" value="Anisokor" <?php if (@$asesmen['pupil']=='Anisokor') {echo "checked";} ?> class="custom-control-input">
                                  <label class="custom-control-label" for="pupil2">Anisokor</label>
                                </div>
                                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                                  <input type="radio" id="pupil3" name="pupil" value="Pain" <?php if (@$asesmen['respon']=='Pain') {echo "checked";} ?> class="custom-control-input">
                                  <label class="custom-control-label" for="pupil3">Pain</label>
                                </div>
                                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                                  <input type="radio" id="pupil4" name="pupil" value="Unrespon" <?php if (@$asesmen['respon']=='Unrespon') {echo "checked";} ?> class="custom-control-input">
                                  <label class="custom-control-label" for="pupil4"> <input type="text" class="form-control" name="pupil_lain" value="" placeholder="Lainnya"> </label>
                                </div>
                                <br><br>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-lg-10 row">
                              <div class="col-12 col-lg-12 input-group">
                                ...
                                <input type="text" class="form-control" aria-label="" name="GCS_E" value="<?php echo @$asesmen['GCS_E'] ?>">
                                <div class="input-group-prepend">
                                  <span class="input-group-text">V :</span>
                                </div>
                                <input type="text" class="form-control" aria-label="" name="GCS_V" value="<?php echo @$asesmen['GCS_V'] ?>">
                                <div class="input-group-prepend">
                                  <span class="input-group-text">M :</span>
                                </div>
                                <input type="text" class="form-control" aria-label="" name="GCS_M" value="<?php echo @$asesmen['GCS_M'] ?>">
                              </div>
                            </div>
            ...
            <div class="card-body card-block row">
              ...
              <div class="col-sm-12 col-lg-4">
                <div class="col-sm-12 col-lg-12 custom-control custom-radio">
                  <input type="radio" id="cidera1" name="cidera" value="Nyeri" <?php if (@$asesmen['cidera']=='Nyeri') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="cidera1">Nyeri</label>
                </div>
                <div class="col-sm-12 col-lg-12 custom-control custom-radio">
                  <input type="radio" id="cidera2" name="cidera" value="Keterbatasan Gerak" <?php if (@$asesmen['cidera']=='Keterbatasan Gerak') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="cidera2">Keterbatasan Gerak</label>
                </div>
                <div class="col-sm-12 col-lg-12 custom-control custom-radio">
                  <input type="radio" id="cidera3" name="cidera" value="Deformitas" <?php if (@$asesmen['cidera']=='Deformitas') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="cidera3">Deformitas</label>
                </div>
                <div class="col-sm-12 col-lg-12 custom-control custom-radio">
                  <input type="radio" id="cidera4" name="cidera" value="Abrasi" <?php if (@$asesmen['cidera']=='Abrasi') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="cidera4">Abrasi</label>
                </div>
                <div class="col-sm-12 col-lg-12 custom-control custom-radio">
                  <input type="radio" id="cidera5" name="cidera" value="Leserasi" <?php if (@$asesmen['cidera']=='Leserasi') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="cidera5">Leserasi</label>
                </div>
                <div class="col-sm-12 col-lg-12 custom-control custom-radio">
                  <input type="radio" id="cidera6" name="cidera" value="Kontusio" <?php if (@$asesmen['cidera']=='Kontusio') {echo "checked";} ?> class="custom-control-input">
              ...
              <div class="col-sm-12 col-lg-4">
                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                  <input type="radio" id="luka1" name="luka" value="Luka Bakar" <?php if (@$asesmen['luka']=='Luka Bakar') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="luka1">Luka Bakar</label>
                </div>
                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                  <input type="radio" id="luka2" name="luka" value="Gigitan" <?php if (@$asesmen['luka']=='Gigitan') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="luka2">Gigitan</label>
                </div>
                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                  <input type="radio" id="luka3" name="luka" value="Tusuk" <?php if (@$asesmen['luka']=='Tusuk') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="luka3">Tusuk</label>
                </div>
                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                  <input type="radio" id="luka4" name="luka" value="V Apertum" <?php if (@$asesmen['luka']=='V Apertum') {echo "checked";} ?> class="custom-control-input">
                  <label class="custom-control-label" for="luka4">V. Apertum</label>
                </div>
                <div class="col-sm-12 col-lg-6 custom-control custom-radio">
                  <input type="radio" id="luka5" name="luka" value="Ptichiae" <?php if (@$asesmen['luka']=='Ptichiae') {echo "checked";} ?> class="custom-control-input">
