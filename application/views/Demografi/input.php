                      ...
                      <div class="card-body card-block">
                        <div class="row form-group">
                          ...
                          <div class="input-group mb-3 col-md-6">
                            <input type="date" class="form-control" aria-label="" name="tanggal_kunjungan" value="<?php echo date('d-m-Y') ?>">
                        ...
                        <div class="row form-group">
                          ...
                          <div class="input-group mb-3 col-md-9">
                            <div class="col-12 col-lg-1 custom-control custom-radio">
                              <input type="radio" id="rujukan1" name="rujukan" class="custom-control-input" value="Ya" <?php if (@$demografi['keadaan']=='Baik') {echo "checked";}?> >
                              <label class="custom-control-label" for="rujukan1">ya</label>
                            </div>
                            <div class="col-12 col-lg-1 custom-control custom-radio">
                              <input type="radio" id="rujukan2" name="rujukan" checked class="custom-control-input" value="Tidak" <?php if (@$demografi['keadaan']=='Baik') {echo "checked";}?> >
                      ...
                      <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                          ...
                          <div class="col-12 col-md-10 row">
                            ...
                            <div class="col-12 col-lg-2 custom-control custom-radio">
                              <input type="radio" id="cara_pembayaran3" name="cara_pembayaran" value="BPJS" <?php if (@$jenispasien['jenis_pasien']=="BPJS") {echo "checked";} ?> class="custom-control-input">
                            ...
                            <div class="col-12 col-lg-5 custom-control custom-radio">
                              ...
                              <?php if (@$demografi['cara_pembayaran']!=='Pribadi' && @$demografi['cara_pembayaran']!=='Asuransi' && @$demografi['cara_pembayaran'] !== 'BPJS' && @$demografi['cara_pembayaran'] !== null) {echo "checked";} ?>>
                              ...
                              <?php if (@$demografi['cara_pembayaran']!=='Pribadi' && @$demografi['cara_pembayaran']!=='Asuransi' && @$demografi['cara_pembayaran'] !== 'BPJS' && @$demografi['cara_pembayaran'] !== null) {echo "value='".@$demografi['cara_pembayaran']."'";} ?> > </label>
                            </div>
                          </div>
                        </div>
                        <div class="row form-group">
                  ...
                  <div class="card border-info" style="border: 2px solid;">
                    ...
                    <div class="card-body card-block">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-12 col-md-12 row">
                          <div class="col-12 col-lg-4 custom-control custom-radio">
                            <input type="radio" id="penyakit_dahulu1" checked value="Tidak Ada" <?php if (@$demografi['penyakit_dahulu']=="Tidak Ada") {echo "checked";} ?> name="penyakit_dahulu" class="custom-control-input">
                          ...
                          <div class="col-12 col-lg-4 custom-control custom-radio">
                            <input type="radio" id="penyakit_dahulu8" name="penyakit_dahulu" value="lain" class="custom-control-input">
                      ...
                      <div class="row form-group col-12">
                        <div class="col-lg-3">
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="pn_bb">
                            <div class="input-group-append">
                        ...
                        <div class="col-lg-3">
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="pn_tb">
                            <div class="input-group-append">
                        ...
                        <div class="col-lg-3">
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="pn_imt">
                            <div class="input-group-append">
