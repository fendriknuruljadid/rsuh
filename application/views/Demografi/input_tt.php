                          ...
                          <div class="row p-t-20 p-b-50">
                            ...
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              ...
                              <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" aria-label="" name="siastole" value="<?php echo @$demografi['td'] ?>" >
                                <div class="input-group-append">
                                ...
                                <input type="text" class="form-control" aria-label="" name="diastole" value="<?php echo @$demografi['hr'] ?>" >
                                <div class="input-group-append">
                                  <span class="input-group-text">mmhg</span>
                                </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-sm-12">
                              ...
                              <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" aria-label="" name="nadi" value="<?php echo @$demografi['nadi'] ?>" >
                                <div class="input-group-append">
                                ...
                                <input type="text" class="form-control rr" aria-label="" name="rr" value="<?php echo @$demografi['rr'] ?>" >
                                <div class="input-group-append">
                                  <span class="input-group-text">x/menit</span>
                                </div>
                      ...
                      <div class="card-body card-block">
                        <div class="row p-t-20">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="oksigen" value="<?php echo @$demografi['suhu'] ?>" >
                            <div class="input-group-append">
                      ...
                      <div class="card-body card-block">
                        <div class="row p-t-20">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="diameter1" value="<?php echo @$demografi['suhu'] ?>" >
                            <div class="input-group-append">
                              <span class="input-group-text">mm</span>
                            </div>

                            <input type="text" class="form-control" aria-label="" name="diameter2" value="<?php echo @$demografi['suhu'] ?>" >
                            <div class="input-group-append">
                              <span class="input-group-text">mm</span>
                            </div>
                      ...
                      <div class="card-body card-block"  style="padding-bottom:470px">
                        <div class="row p-t-20">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="oral" value="<?php echo @$demografi['suhu'] ?>" >
                            <div class="input-group-append">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="parenteral" value="<?php echo @$demografi['suhu'] ?>" >
                            <div class="input-group-append">
                              <span class="input-group-text">cc/hr</span>
                            </div>
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="produksi_urine" value="<?php echo @$demografi['suhu'] ?>" >
                            <div class="input-group-append">
                      ...
                      <div class="card-body card-block">
                        <div class="row p-t-20">
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="" name="abdomen" value="<?php echo @$demografi['suhu'] ?>" >
                            <div class="input-group-append">
                          ...
                          <div class="col-12 col-md-12 row">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="text" class="form-control" aria-label="" name="lokasi_nyeri_tekan" value="<?php echo @$demografi['suhu'] ?>" >
                              <!-- <div class="input-group-append">
                              <span class="input-group-text">cm</span>
                            </div> -->
                          </div>
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" aria-label="" name="bising_usus" value="<?php echo @$demografi['suhu'] ?>" >
                          <div class="input-group-append">
                            <span class="input-group-text">x/menit</span>
                          </div>
                        </div>
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" aria-label="" name="frekuensi" value="<?php echo @$demografi['suhu'] ?>" >
                          <div class="input-group-append">
                          ...
                          <input type="text" class="form-control" aria-label="" name="jumlah" value="<?php echo @$demografi['suhu'] ?>" >
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" aria-label="" name="bab" value="<?php echo @$demografi['suhu'] ?>" >
