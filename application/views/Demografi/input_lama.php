                        ...
                        <div class="col-md-4">
                          <div class="form-group animated flipIn m-l-10">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="number" name="bb" class="form-control" placeholder="BB" value="<?php echo @$demografi['pn_bb']?>">
                        ...
                        <div class="col-md-4">
                          <div class="form-group animated flipIn">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="number" name="tb" class="form-control" placeholder="TB" value="<?php echo @$demografi['pn_tb']?>">
                        ...
                        <div class="col-md-4">
                          <div class="form-group animated flipIn">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="text" name="temp" class="form-control" placeholder="Temp" value="<?php echo @$demografi['suhu']?>" >
                        ...
                        <div class="col-md-4">
                          <div class="form-group animated flipIn">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="number" name="rr" class="form-control" placeholder="---" value="<?php echo @$demografi['rr']?>">
