    ...
    function set_tabel(data){
      ...
      for (var i = 0; i < data.length; i++) {
        html +=
          ...
          '<td><input type="hidden" name="harga[]" id="harga_'+data[i].iddetail_resep+'" class="harga_resep" value="'+data[i].harga+'" <i>Rp.</i>'+data[i].harga+'</td>'+
          '<td><input type="hidden" name="jumlah_awal[]" value="'+data[i].jumlah+'">'+data[i].jumlah+'</td>'+
          '<td id="t_total_v_'+data[i].iddetail_resep+'"><input type="hidden" class="total_harga" name="total_harga[]" id="total_'+data[i].iddetail_resep+'" value="'+data[i].total_harga+'"><i>Rp.</i>'+data[i].total_harga+'</td>'+
