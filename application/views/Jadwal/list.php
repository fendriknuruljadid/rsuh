...
<?php echo form_open('Jadwal/delete');?>
<div class="row">
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Jadwal Dokter</a>
            <div>
              <a href="<?php base_url(); ?>Jadwal/input" class="float-right">
                ...
                <?php $no = 1; foreach ($jadwal as $data):
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td>
                        <a href="<?php echo base_url().'Jadwal/edit/'.$id_check; ?>">
