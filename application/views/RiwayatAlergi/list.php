    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
          <div>
            ...
            <div>
              <a href="<?php echo base_url(); ?>RiwayatAlergi/input/<?php echo $pasien['noRM'] ?>" class="float-right">
      ...
      <div class="card-body row">
        ...
        <div class="col-md-4">
          ...
          <input type="text" class="form-control" id="norm" value="<?php echo $pasien['tgl_lahir'] ?>" readonly>
        </div>
              ...
              <tbody>
                <?php $no = 1; foreach ($riwayat_alergi as $data):
                  ...
                  <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url().'RiwayatAlergi/edit/'.$pasien['noRM'].'/'.$id_check; ?>">
