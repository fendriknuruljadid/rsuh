...
<div class="card">
  <div class="card-body card-block">
    ...
    <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
              <div class="custom-control custom-radio">
                <input type="radio" id="l" name="rugi_laba" value="1" class="custom-control-input" required>

                <label class="custom-control-label" for="l">Rugi/Laba</label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" id="l2" name="rugi_laba" value="2" class="custom-control-input" required>
    ...
    <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
              <div class="custom-control custom-radio">
                <input type="radio" id="pn1" name="pos" value="1" class="custom-control-input" required>

                <label class="custom-control-label" for="pn1">Aktiva Lancar</label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" id="pn2" name="pos" value="2" class="custom-control-input" required>

                <label class="custom-control-label" for="pn2">Aktiva Tetap</label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" id="pn3" name="pos" value="3" class="custom-control-input" required>

                <label class="custom-control-label" for="pn3">Pasiva (Hutang)</label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" id="pn4" name="pos" value="4" class="custom-control-input" required>
