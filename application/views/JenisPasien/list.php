...
<?php echo form_open('JenisPasien/delete');?>
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Jenis Pasien</a>
            <div>
              <a href="<?php base_url(); ?>JenisPasien/input" class="float-right">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1; foreach ($jenis_pasien as $data) {?>
                    <?php $id_check = $data->kode_jenis;?>
                    <tr>
                        ...
                        <td><a href="<?php base_url()?>JenisPasien/edit/<?php echo $data->kode_jenis;?>">
