                        ...
                        <div class="pull-right m-t-30">
                          <div class="col col-md-12 pull-right">
                            <table border="0">
                              ...
                              <!-- <tr>
                                <td><h5><b>Pembayaran :</b><td> <i>Rp</i></td><h5></td><td><input name="jml_bayar" id="bayar" onkeyup="filter()" type="text" class="form-control money" ></td>
                              </tr>
                              <tr>
                                <td><h5><b>Kembalian       :</b><td> <i>Rp</i></td></h5></td><td><h5><input name="kembalian" id="kembalian" type="text" class="form-control money" readonly></h5></td>
                              </tr> -->
                            </table>
