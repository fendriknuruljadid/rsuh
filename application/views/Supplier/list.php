    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
          <div>
            ...
            <a href="" class="white-text mx-3">Supplier Obat</a>
            <div>
              <a href="<?php base_url(); ?>Supplier/input" class="float-right">
              ...
              <tbody>
                <?php $no = 1; foreach ($supplier as $data):
                  ...
                  <tr>
                      ...
                      <td><?php echo $data->alamat.' '.$data->kota; ?></td>
                      <td><?php echo $data->telepon; ?></td>
                      <td>
                        <a href="<?php echo base_url().'Supplier/edit/'.$id_check; ?>">
