        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body card-block">
              <?php echo form_open_multipart('Jabatan/update');?>
              <?php echo @$error;?>
              ...
              <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                  <input type="text" name="kode" id="kode" class="form-control" placeholder="Kode Jabatan" value="<?php echo @$idjabatan; ?>" required <?php if (isset($idjabatan)): ?>
                    readonly
                  <?php endif; ?>>
                </div>
              </div>
