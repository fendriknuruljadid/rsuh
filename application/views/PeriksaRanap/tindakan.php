<div class="main-content">
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <?php echo form_open_multipart('PeriksaRanap/input_ditin');?>
      <div class="row">
          ...
          <table id="example" class="table table-hover table-borderless table-striped">
            ...
            <tbody>
              <?php $no=1; foreach ($modaljapel as $data) {?>
                ...
                if ($kunjungan['kelas']==3) {
                  $harga = $data->hrg_2;
                  $jasa_dokter = $data->jasa_dokter_2;
                  $jasa_perawat = $data->jasa_perawat_2;
                  $jasa_admin = $data->jasa_admin_2;
                  $jasa_resepsionis = $data->jasa_resepsionis_2;
                }else if($kunjungan['kelas']==2){
                  $harga = $data->hrg_3;
                  $jasa_dokter = $data->jasa_dokter_3;
                  $jasa_perawat = $data->jasa_perawat_3;
                  $jasa_admin = $data->jasa_admin_3;
                  $jasa_resepsionis = $data->jasa_resepsionis_3;
                }else if ($kunjungan['kelas']==1) {
                  $harga = $data->hrg_4;
                  $jasa_dokter = $data->jasa_dokter_4;
                  $jasa_perawat = $data->jasa_perawat_4;
                  $jasa_admin = $data->jasa_admin_4;
                  $jasa_resepsionis = $data->jasa_resepsionis_4;
                }else{
                  $harga = $data->hrg_1;
                  $jasa_dokter = $data->jasa_dokter_1;
                  $jasa_perawat = $data->jasa_perawat_1;
                  $jasa_admin = $data->jasa_admin_1;
                  $jasa_resepsionis = $data->jasa_resepsionis_1;
                ...
                <tr>
                  ...
                  <td><button type="button"
                    onclick="select_jasa('<?php echo $data->kode_jasa?>', '<?php echo $data->nama?>', '<?php echo $harga; ?>', '<?php echo $jasa_dokter; ?>', '<?php echo $jasa_perawat; ?>','<?php echo $jasa_admin; ?>', '<?php echo $jasa_resepsionis; ?>' )"
