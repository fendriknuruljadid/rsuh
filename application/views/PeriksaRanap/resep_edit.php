<div class="main-content">
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <?php echo form_open_multipart('PeriksaRanap/update_resep/'.$this->uri->segment(4));?>
      <div class="row">
        <div class="col-lg-12">
...
<div class="modal fade" id="scrollmodal" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
            ...
            <tbody>
              <?php $no = 1; foreach ($resep as $data):
                ...
                <tr>
                  ...
                  <td>
                    <button id="<?php echo $id;?>" kelas="<?php echo $kunjungan['kelas'];?>"  class="btn-floating aqua-gradient add_obat" data-toggle="tooltip" data-placement="top" title="" data-original-title="TambahKan" >
  ...
  $(document).on("click",".add_obat",function(){
    ...
    select_obat(idobat,kelas);
  })
  function select_obat(kode,kelas) {
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url();?>PeriksaRanap/cariobat/' + kode,
      data: { idobat: kode,kelas_rawat:kelas },
      dataType:'json',
      async : false,
