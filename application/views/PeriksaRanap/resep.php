...
<div class="main-content">
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <?php echo form_open_multipart('PeriksaRanap/input_resep');?>
      <div class="row">
        <div class="col-lg-12">
...
<div class="modal fade" id="scrollmodal" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
  ...
  function tambahobat(res) {
    ...
    "<td><button type=\"button\"' class=\"btn-danger hapus item-table\" data-toggle=\"tooltip\" data-placement=\"top\" data-original-title=\"Hapus Lab\"><i class=\"fa fa-trash\"></i></button></td>" +
    "</tr>";
